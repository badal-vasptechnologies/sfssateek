! function () {
        ...
        n.querySelector(".country-flagimg") && (e = n.querySelector(".country-flagimg").getAttribute("src")), Array.from(n.querySelectorAll(".dropdown-menu li")).forEach(function (r) {
            ...
            Array.from(t.querySelectorAll(".dropdown-menu li")).forEach(function (e) {
                ...
                e.addEventListener("click", function () {
                    t.querySelector(".flag-input").value = r
                }), n == r && (e.classList.add("active"), t.querySelector(".flag-input").value = e.querySelector(".country-name").innerHTML)
            })
        })
    }
    e = "country-list.json", r = function (e, r)
    {
    ...
    }, (t = new XMLHttpRequest).open("GET", "../assets/json/" + e+"?v=1.0.1", !0), t.responseType = "json", t.onload = function () {
        var e = t.status;
        ...
        o && o.addEventListener("keyup", function () {
            ...
            r = e;
            var r, t = l.filter(function (e) {
                return -1 !== e.countryName.toLowerCase().indexOf(r.toLowerCase()) || -1 !== e.countryCode.indexOf(r)
            });
            setTimeout(function () {
                n.querySelector(".dropdown-menu-list").innerHTML = "", Array.from(t).forEach(function (e) {
                    n.querySelector(".dropdown-menu-list").innerHTML += '<li class="dropdown-item d-flex">                        <div class="flex-shrink-0 me-2"><img src="' + e.flagImg + '" alt="country flag" class="options-flagimg" height="20"></div>                        <div class="flex-grow-1">                        <div class="d-flex"><div class="country-name me-1">' + e.countryName + '</div><span class="countrylist-codeno text-muted">' + e.countryCode + "</span></div>                        </div>                        </li>"
                }), a(n)
            }, 350)
        })
    })
