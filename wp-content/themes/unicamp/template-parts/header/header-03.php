...
<header id="page-header" <?php Unicamp_Header::instance()->get_wrapper_class(); ?>>
	...
	<div id="page-header-inner" class="page-header-inner" data-sticky="1">
		<div class="container">
					...
					<div class="header-content-inner">
						<div id="header-right-inner" class="header-right-inner">
							<div class="header-right-inner-content">
								...
								<?php Unicamp_Header::instance()->print_buttons( array( 'size' => 'xxs' ) ); ?>
								

                                
								<div class="header-custom-icon" id="customMenu">
		    ...
		    <!--<div class="header-custom-image" align="right" >-->
      <!--          <a href="https://dc.sfsguwahati.in/" target="_blank">-->
      <!--              <img src="https://sn.laksvrddhi.com/wp-content/uploads/2025/11/desalite.png" id="menuImg" />-->
      <!--          </a>-->
      <!--      </div>-->
		</div>
