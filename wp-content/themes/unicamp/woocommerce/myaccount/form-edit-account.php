...
<form class="woocommerce-EditAccountForm edit-account" action=""
	...
	<div class="row form-row ">
		<div class="col-md-6">
			<label for="account_first_name"><?php esc_html_e( 'First name', 'unicamp' ); ?>&nbsp;<span
		...
		<div class="col-md-6">
			<label for="account_last_name"><?php esc_html_e( 'Last name', 'unicamp' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<div class="row form-row">
		<div class="col-md-6">
			<label for="account_display_name"><?php esc_html_e( 'Display name', 'unicamp' ); ?>&nbsp;<span
					class="required">*</span></label>
			...
			<span><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'unicamp' ); ?></em></span>
		</div>
		<div class="col-md-6">
			<label for="account_email"><?php esc_html_e( 'Email address', 'unicamp' ); ?>&nbsp;<span
					class="required">*</span></label>
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password change', 'unicamp' ); ?></legend>

		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label
				for="password_current"><?php esc_html_e( 'Current password', 'unicamp' ); ?></label>
			...
			<span><em><?php esc_html_e( 'Leave blank to leave unchanged.', 'unicamp' ); ?></em></span>
		</p>
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label
				for="password_1"><?php esc_html_e( 'New password', 'unicamp' ); ?></label>
		...
		<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
			<label for="password_2"><?php esc_html_e( 'Confirm new password', 'unicamp' ); ?></label>
	...
	<p>
		...
		<button type="submit"
		        ...
		        value="<?php esc_attr_e( 'Save changes', 'unicamp' ); ?>"><?php esc_html_e( 'Save changes', 'unicamp' ); ?></button>
