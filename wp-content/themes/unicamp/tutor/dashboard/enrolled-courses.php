...
<h3><?php esc_html_e( 'Enrolled Courses', 'unicamp' ); ?></h3>
...
<div class="tutor-dashboard-content-inner">
						...
						<div class="tutor-meta tutor-course-metadata">
							...
							<ul class="course-meta">
								<li class="course-meta-lesson-count">
									<span class="meta-label"><?php esc_html_e( 'Total Lessons:', 'unicamp' ); ?></span>
									<span class="meta-value"><?php echo number_format_i18n( $total_lessons ); ?></span>
								</li>
								<li class="course-meta-completed-lessons">
									<span
										class="meta-label"><?php esc_html_e( 'Completed Lessons:', 'unicamp' ); ?></span>
									<span
	...
	<?php else: ?>
		<div class="dashboard-no-content-found">
			<?php esc_html_e( 'You didn\'t purchased any courses.', 'unicamp' ); ?>
		</div>
	<?php endif; ?>
