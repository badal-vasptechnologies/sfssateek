...
if ( ! class_exists( 'Unicamp_WP_Widget_Course_Location_Filter' ) ) {
	class Unicamp_WP_Widget_Course_Location_Filter extends Unicamp_Course_Layered_Nav_Base {

		public function __construct() {
			$this->widget_id          = 'unicamp-wp-widget-course-location-filter';
			$this->widget_cssclass    = 'unicamp-wp-widget-course-location-filter unicamp-wp-widget-filter unicamp-wp-widget-course-filter';
			$this->widget_name        = esc_html__( '[Unicamp] Course Location Filter', 'unicamp' );
			$this->widget_description = esc_html__( 'Shows location in a widget which lets you narrow down the list of courses when viewing courses.', 'unicamp' );
			$this->settings           = array(
				'title'        => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Filter by location', 'unicamp' ),
